...
The Flow webhook enables you to trigger automated WhatsApp message flows by sending HTTP POST requests. When a valid request is received, the system processes the data and initiates the flow execution, sending template messages through WhatsApp.

### Path Parameters

<ParamField path="id" type="string" required>
  The ID of the flow you want to trigger. You can find your flow ID in the
  TextYess UI.
</ParamField>
...
<ParamField body="phone_number" type="string" required initialValue="3475156348" placeholder="3475156348">
  The recipient's phone number, without the country code
</ParamField>
