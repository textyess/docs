...
<ParamField body="id" type="string" required initialValue="1234">
  The id of the order
</ParamField>
...
<ParamField body="shipping_address" type="object">
  ...
  <Expandable title="Show object properties">
    <ParamField body="first_name" type="string" required initialValue="John">
      First name for shipping
    </ParamField>
    <ParamField body="last_name" type="string" required initialValue="Doe">
