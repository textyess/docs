...
The bulk update endpoint is limited to 500 products per request to ensure optimal performance.
...
5. **Idempotency**: The operation is idempotent - sending the same update multiple times won't cause issues.
