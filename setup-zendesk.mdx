...
5. If a **human agent** sends a message to the customer from Zendesk, **the AI immediately stops replying**, and the ticket will **exclusvely be handled manually by the human agent**.