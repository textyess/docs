...
description: "Learn about the different types of WhatsApp Business Accounts and how to set up your business account for TextYess integration."
---

WhatsApp Business Platform offers different types of business accounts to help you connect with your customers. Understanding these account types is crucial for setting up your TextYess integration properly.
...
<Steps>
  ...
  <Step title="Submit OBA Request">
    Access WhatsApp Manager from your Business Manager and: - Click on the phone
    number you want to verify - Click the "Submit Request" button - Provide
    required information including: - Up to 5 supporting links from reputable
    publications - Countries of operation - Parent business/brand information -
    Primary language
  </Step>
